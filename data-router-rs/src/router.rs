...
impl AgentScopeManager {
    ...
    pub async fn apply_scope_filter(
        &self,
        agent_id: &str,
...
pub fn add_scope_metadata_to_response(
...
mod tests {
    ...
    async fn test_scope_validation() {
        ...
        assert!(
            scope_manager
                .can_access_scope("RED-TEAM-SHADOW", "RED_TEAM")
                .await
        );
        assert!(
            scope_manager
                .can_access_scope("BLUE-TEAM-SENTINEL", "BLUE_TEAM")
                .await
        );
        ...
        assert!(
            !scope_manager
                .can_access_scope("RED-TEAM-SHADOW", "BLUE_TEAM")
                .await
        );
        assert!(
            !scope_manager
                .can_access_scope("BLUE-TEAM-SENTINEL", "RED_TEAM")
                .await
        );
        ...
        assert!(
            scope_manager
                .can_access_scope("RED-TEAM-SHADOW", "PUBLIC")
                .await
        );
        assert!(
            scope_manager
                .can_access_scope("BLUE-TEAM-SENTINEL", "PUBLIC")
                .await
        );
        ...
        assert!(
            scope_manager
                .can_access_scope("SYSTEM-ADMIN", "RED_TEAM")
                .await
        );
        assert!(
            scope_manager
                .can_access_scope("SYSTEM-ADMIN", "BLUE_TEAM")
                .await
        );
    }
    ...
    async fn test_scope_filter_application() {
        ...
        let filtered_query = scope_manager
            .apply_scope_filter("RED-TEAM-SHADOW", query.clone())
            .await;
        ...
        let system_query = scope_manager
            .apply_scope_filter("SYSTEM-ADMIN", query.clone())
            .await;
