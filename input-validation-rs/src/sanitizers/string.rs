...
lazy_static! {
    static ref CONTROL_CHARS_REGEX: Regex = Regex::new(r"[\x00-\x08\x0B\x0C\x0E-\x1F\x7F]").unwrap();
...
pub fn remove_control_chars(input: &str) -> SanitizeResult<String> {
    ...
    if sanitized == input {
        ...
        SanitizeResult::modified(
            sanitized,
            Some("Removed control characters".to_string())
        )
    }
}
...
pub fn limit_length(input: &str, max_length: usize) -> SanitizeResult<String> {
    if input.len() <= max_length {
        ...
        SanitizeResult::modified(
            truncated,
            Some(format!("Truncated string from {} to {} characters", input.len(), max_length))
        )
    }
}
...
pub fn trim_whitespace(input: &str) -> SanitizeResult<String> {
    ...
    if trimmed == input {
        ...
        SanitizeResult::modified(
            trimmed,
            Some("Trimmed whitespace".to_string())
        )
    }
}
...
pub fn keep_allowed_chars(input: &str, allowed: &str) -> SanitizeResult<String> {
    ...
    if result == input {
        ...
        SanitizeResult::modified(
            result,
            Some("Removed disallowed characters".to_string())
        )
    }
}
...
pub fn replace_chars(input: &str, replacements: &[(char, &str)]) -> SanitizeResult<String> {
    ...
    if was_modified {
        SanitizeResult::modified(
            result,
            Some("Replaced characters".to_string())
        )
    } else {
        SanitizeResult::unmodified(input.to_string())
    }
...
pub fn normalize_line_endings(input: &str) -> SanitizeResult<String> {
    ...
    if result == input {
        ...
        SanitizeResult::modified(
            result,
            Some("Normalized line endings".to_string())
        )
    }
}
...
pub fn collapse_whitespace(input: &str) -> SanitizeResult<String> {
    ...
    if result == input {
        ...
        SanitizeResult::modified(
            result,
            Some("Collapsed whitespace".to_string())
        )
    }
}
...
pub fn to_lowercase(input: &str) -> SanitizeResult<String> {
    ...
    if result == input {
        ...
        SanitizeResult::modified(
            result,
            Some("Converted to lowercase".to_string())
        )
    }
}
